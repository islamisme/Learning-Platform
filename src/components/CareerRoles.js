export const CareerRoles = [
...

  {
    ...
    description:
      "A Python Developer specializes in writing server-side web application logic, building robust backends with scalable architectures.",
    likes:
