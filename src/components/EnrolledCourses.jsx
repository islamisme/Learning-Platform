  ...
  return (
    <div className="space-y-6 text-white">
      <div className="space-y-2">
        <h1 className="text-3xl font-semibold text-[#F5F7FF]">الدورات المسجلة</h1>
        <p className="text-sm text-[#C7CCF5]">تابع تقدمك في الدورات المسجلة من المسارات المهنية</p>
      </div>
      ...
      {enrolledCourses.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-white/10 bg-white/[0.02] p-12 text-center">
          ...
          <p className="text-xs text-[#C7CCF5]">ابدأ رحلتك التعليمية من متجر الدورات</p>
        </div>
      )}
    </div>
  )
